...
export class PromocionController{
    ...
    public async listarTrianaPromocion(req:Request, res:Response)
    {
        ...
        let triana_promocion = await db.query("select pr.id_promo, p.nombre as producto, d.porcentaje as descuento from promociones pr, producto p, descuento d where pr.producto = p.id_producto and pr.descuento = d.id_des");
