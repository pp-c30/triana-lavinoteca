...
//enrutadorOpinion.route('/triana_opinion').get(trianaController.listarTrianaOpinion); //obtener datos y mostrarlo
...
//enrutadorOpinion.route('/triana_opinion/:codigo_triana_opinion').put(trianaController.actualizarTrianaOpinion); //actualiza datos de la base de datos
//enrutadorOpinion.route('/triana_opinion/:codigo_triana_opinion').get(trianaController.obtenerUnTrianaOpinion); //obtiene un valor de a bae de atos
