...
class PromocionController {
    ...
    listarTrianaPromocion(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let triana_promocion = yield db.query("select pr.id_promo, p.nombre as producto,p.id_producto as id_p, d.id_des as id_des, concat(d.descripcion,'  -  ',d.porcentaje) as descuento from promociones pr, producto p, descuento d where pr.producto = p.id_producto and pr.descuento = d.id_des");
